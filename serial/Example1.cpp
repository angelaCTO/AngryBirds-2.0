...
int main()
{
    ...
    Ret=LS.WriteChar('X');                                             // Send the command on the serial port
    ...
    Ret=LS.ReadString(Buffer,'\n',128,100000);                                // Read a maximum of 128 characters with a timeout of 5 seconds 	 	                                                                           // The final character of the string must be a line feed ('\n')
    if (Ret>0)
	{
