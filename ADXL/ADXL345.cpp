...
void ADXL345::initialize() {
	/* added by Ali for self test */
	i2c.writeByte(ADXL345_RA_DATA_FORMAT, 0x80);
	sleep(1);
	i2c.writeByte(ADXL345_RA_DATA_FORMAT, 0x00);
	/* end mod by Ali */
...
void ADXL345::getAcceleration(int16_t* x, int16_t* y, int16_t* z) {
	...
	int16_t array = i2c.readStream(ADXL345_RA_DATAX0,ADXL345_RA_DATAX1,
